...
export function Header() {
  ...
  // The navigation follows the categories the owner publishes.
  useEffect(() => {
                ...
                >
                  ...
                  <div className="flex items-center gap-3">
                    <Link
                      ...
                      onClick={() => setIsMenuOpen(false)}
                      className="flex items-center gap-2 px-5 py-2.5 rounded-full bg-white/8 border border-white/10 hover:bg-white/15 text-white/80 hover:text-[#E89B3C] transition-all duration-300 text-sm"
                    >
                    ...
                    <Link
                      ...
                      onClick={() => setIsMenuOpen(false)}
                      aria-label="Wishlist"
                      className="p-2.5 rounded-full bg-white/8 border border-white/10 hover:bg-white/15 text-white/80 hover:text-[#E89B3C] transition-all duration-300"
                    >
                    ...
                    <Link
                      ...
                      className="p-2.5 rounded-full bg-white/8 border border-white/10 hover:bg-white/15 text-white/80 hover:text-[#E89B3C] transition-all duration-300 relative inline-flex"
                    >
